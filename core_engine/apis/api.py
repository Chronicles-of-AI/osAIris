...
from apis.routes.aws.project_router import project_router
from apis.routes.aws.model_router import model_router
from apis.routes.aws.sagemaker_router import sagemaker_router
from apis.routes.aws.comprehend_router import comprehend_router
from apis.routes.label_studio.project_router import (
    project_router as label_studio_project_router,
)
from apis.routes.gcp.create_dataset_router import create_dataset_router
from apis.routes.gcp.import_dataset_router import import_dataset_router
from apis.routes.gcp.manage_model_router import manage_model_router
from apis.routes.gcp.model_predictions_router import get_predictions_router
from apis.routes.gcp.train_model_router import train_model_router
from apis.routes.gcp.manage_dataset_router import manage_dataset_router
from apis.routes.gcp.operations_router import operations_router
